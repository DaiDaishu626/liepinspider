...
url1 ='D:/BDY/Python/baike spider/jt/www3.html'
htmldownloader = HtmlDownloader()
html_cont = htmldownloader.download(url1)
htmlparser = HtmlParser()
htmlurl = htmlparser.parse_url(html_cont)
count = 1
print(htmlurl)

#url2 =
#htmldownloader = HtmlDownloader()
#html_cont = htmldownloader.download(url2)
#htmlparser = HtmlParser()
#htmldata = htmlparser.parse_data(url2,html_cont)
#print (htmldata)
